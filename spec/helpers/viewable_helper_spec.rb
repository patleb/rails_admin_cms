...
describe CMS::ViewableHelper, type: :helper do
  describe "#cms_link" do
    ...
    context "without min and max" do
      ...
      it { expect(subject.edit_link).to match /<a data-js-cms-editable-id="\d" class="cms-edit cms-edit-viewable-link" data-no-turbolink="true" href=".+">/ }
    end
    ...
    context "with min = 2 and max = 2" do
      ...
      it { expect(subject.edit_links).to match /<ul data-js-cms-sortable=\"{.+}\" class="cms-edit-links"><li data-js-cms-sortable-id="\d">/ }
    end
